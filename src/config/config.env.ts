...
const confEnv = {
    ...
    PSQLHOST: process.env.PSQLHOST,
    PSQLPORT: process.env.PSQLPORT,
    PSQLUSERNAME: process.env.PSQLUSERNAME,
    PSQLPASSWORD: process.env.PSQLPASSWORD,
    PSQLNAME: process.env.PSQLNAME,
